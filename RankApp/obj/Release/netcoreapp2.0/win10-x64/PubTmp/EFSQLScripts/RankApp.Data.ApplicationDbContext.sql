...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180523124802_PIB')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180523124802_PIB')
BEGIN
    ALTER TABLE [AspNetUsers] ADD [PIB] nvarchar(max) NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20180523124802_PIB', N'2.0.3-rtm-10026');
END;
